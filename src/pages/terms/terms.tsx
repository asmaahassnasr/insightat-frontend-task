	...
	return (
		<div>
			...
			<div className="privacy container">
				...
				<p>
					<span>1.1.1.</span>
					These general terms and conditions of use ("<span>General Terms and Conditions of Use</span>") shall
					govern the use of the website www.typeform.com and related platform ("<span>Website</span>"), which
					belongs to TYPEFORM. The purpose is to provide information about the activity of the Company and
					enable the use of the services offered by TYPEFORM (“<span>Service</span>” or “<span>Services</span>”),
					consisting in the creation of different types of online documents or forms (hereinafter referred to
					as “<span>typeforms</span>”) and, where appropriate, the subsequent storage of the same.
				</p>

				<p>
					<span>1.2.</span> Agreement to the General Terms and Conditions of Use and, where appropriate, the
					Specific Conditions
				</p>
				<p>
					<span>1.2.1.</span> By accessing the Services, you, the User, agree to these General Terms and
				...
				<p>
					<span>1.2.2.</span> Some of the above-mentioned Services may be subject to specific conditions
				...
				<p>
					<span>1.2.3.</span> In addition, TYPEFORM informs the users of the Services that these General Terms
