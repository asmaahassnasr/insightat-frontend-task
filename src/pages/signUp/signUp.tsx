	...
	render() {
		return (
			<div className="signup">
				<div className="row">
					<div
						className="col-lg-4 signup__wrapper d-flex flex-column justify-content-between"
						style={{ padding: '1% 3% 1% 3%' }}
					>
						<h1 style={{ textAlign: 'center' }}>
							<NavLink className="signup__title" to="/">
								Insightat
							</NavLink>
						</h1>
						...
						<div className="signup__google">
							...
							<button className="btn signup__google__button" style={{ border: '1px solid #ccc' }}>
					...
					<div
						className="col-lg-8 signup__background d-flex flex-column justify-content-end"
